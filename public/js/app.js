...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(['addUser'])), {}, {
    addUser: function addUser() {
      ...
      this.$store.dispatch('addUser', this.newUser).then(function () {
        _this.newUser.name = '';
        _this.newUser.email = '';
        _this.$emit('close');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)(['tasks', 'users'])),
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(['getTasks', 'getUsers', 'addTask', 'completeTask', 'deleteTask'])), {}, {
    addTask: function addTask() {
      ...
      if (this.editMode) {
        ...
        this.$store.dispatch('updateTask', this.newTask).then(function () {
          _this.newTask.title = '';
    ...
    edit: function edit(task) {
      this.editMode = true;
      this.newTask = _objectSpread({}, task);
      this.newTask.user = task.user.id;
    },
    filtering: function filtering(event) {
      this.$store.dispatch('getTasks', event.target.value)["catch"](function (error) {
    ...
    completeTask: function completeTask(task) {
      ...
      this.$swal.fire({
        title: "you want to mark the task  ".concat(task.title, " as ").concat(task.completed ? 'Decomplete' : 'Complete', "?"),
        ...
        if (result.isConfirmed) {
          _this2.$store.dispatch('completeTask', task.id)["catch"](function (error) {
    ...
    deleteTask: function deleteTask(task) {
      ...
      this.$swal.fire({
        title: "are you sure to delete the task  ".concat(task.title, "?"),
        showCancelButton: true,
        ...
        /* Read more about isConfirmed, isDenied below */
        if (result.isConfirmed) {
          _this3.$store.dispatch('deleteTask', task.id)["catch"](function (error) {
  ...
  mounted: function mounted() {
    this.$store.dispatch('getTasks')["catch"](function (error) {
      console.error('Error fetching tasks:', error);
    });
    this.$store.dispatch('getUsers')["catch"](function (error) {
...
var render = function render() {
  ...
  }, [_c("div", [_vm._t("header")], 2), _vm._v(" "), _c("div", [_c("button", {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    staticClass: "container mt-5 h-100"
  }, [_c("div", {
  ...
  }, [_vm._v("Assigned User")]), _vm._v(" "), _c("a", {
  ...
  }, [_vm._v("Select Usuario")]), _vm._v(" "), _vm._l(_vm.users, function (user) {
    return _c("option", {
      domProps: {
        value: user.id
      }
    }, [_vm._v(_vm._s(user.name))]);
  })], 2)]), _vm._v(" "), !_vm.editMode ? _c("button", {
    staticClass: "btn btn-success btn-block",
    attrs: {
      type: "submit"
    }
  }, [_vm._v("Add Task")]) : _c("button", {
    staticClass: "btn btn-warning btn-block",
    attrs: {
      type: "submit"
    }
  }, [_vm._v("Edit Task")])])]), _vm._v(" "), _c("div", {
    ...
    on: {
      click: _vm.addNewTask
    }
  }, [_vm._v("New")])])]), _vm._v(" "), _c("ul", {
    staticClass: "list-group mb-4 overflow-auto",
    staticStyle: {
      height: "400px"
    }
    ...
    }, [_c("div", [_c("h6", {}, [_vm._v(_vm._s(index + 1) + ". " + _vm._s(task.title) + " "), task.completed ? _c("span", {
      staticClass: "badge bg-success text-white"
    }, [_vm._v("Completed")]) : _vm._e()]), _vm._v(" "), _c("p", {}, [_vm._v(_vm._s(task.description))]), _vm._v(" "), _c("small", {
    ...
    }, [_vm._v("\n                    " + _vm._s(task.completed ? "Decomplete" : "Complete") + "\n                ")]), _vm._v(" "), !task.completed ? _c("button", {
      staticClass: "btn btn-info btn-sm",
      on: {
        click: function click($event) {
          return _vm.edit(task);
        }
      }
...
/* harmony import */ var vue_sweetalert2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-sweetalert2 */ "./node_modules/vue-sweetalert2/dist/vue-sweetalert.mjs");
...
var Toast = sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_1___default().mixin({
  toast: true,
  position: "top-end",
  iconColor: "white",
  customClass: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_4__["default"].Store({
  ...
  mutations: {
    ...
    UPDATE_TASK: function UPDATE_TASK(state, updatedTask) {
      ...
      if (index !== -1) {
        vue__WEBPACK_IMPORTED_MODULE_3__["default"].set(state.tasks, index, updatedTask);
      }
    },
  ...
  actions: {
    getTasks: function getTasks(_ref, state) {
      var commit = _ref.commit;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/tasks?state=" + state).then(function (response) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/tasks", task);
            case 3:
              dispatch("getTasks");
              Toast.fire({
                icon: "success",
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              console.log(task.id);
              _context2.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().put("/tasks/".concat(task.id), task);
            case 4:
              dispatch("getTasks");
              Toast.fire({
                icon: "warining",
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/users", user);
            case 3:
              dispatch("getUsers");
              Toast.fire({
                icon: "error",
    ...
    completeTask: function completeTask(_ref6, task) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().put("/completeTasks/".concat(task));
            case 3:
              dispatch("getTasks");
            case 4:
            case "end":
    ...
    deleteTask: function deleteTask(_ref7, taskId) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/tasks/".concat(taskId));
            case 3:
              Toast.fire({
                icon: "error",
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/sweetalert2/src/sweetalert2.scss":
/*!*********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/sweetalert2/src/sweetalert2.scss ***!
  \*********************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Modal.vue?vue&type=style&index=0&id=53ab54d2&lang=css":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Modal.vue?vue&type=style&index=0&id=53ab54d2&lang=css ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _css_loader_dist_cjs_js_clonedRuleSet_12_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_sweetalert2_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./sweetalert2.scss */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/sweetalert2/src/sweetalert2.scss");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_sweetalert2_scss__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_sweetalert2_scss__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_style_index_0_id_53ab54d2_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Modal.vue?vue&type=style&index=0&id=53ab54d2&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Modal.vue?vue&type=style&index=0&id=53ab54d2&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_style_index_0_id_53ab54d2_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Modal_vue_vue_type_template_id_53ab54d2__WEBPACK_IMPORTED_MODULE_0__.render,
  _Modal_vue_vue_type_template_id_53ab54d2__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_template_id_53ab54d2__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_template_id_53ab54d2__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_template_id_53ab54d2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Modal.vue?vue&type=template&id=53ab54d2 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Modal.vue?vue&type=template&id=53ab54d2");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Modal_vue_vue_type_style_index_0_id_53ab54d2_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Modal.vue?vue&type=style&index=0&id=53ab54d2&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Modal.vue?vue&type=style&index=0&id=53ab54d2&lang=css");
